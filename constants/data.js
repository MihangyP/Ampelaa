        ...
        content: [
            {
                ...
                urlImg: images.ceQueSontLesMenstruations,
            },
            {
            ...
            },
            {
                ...
                urlImg: images.phasesDuCycleMenstruel
            },
            {
        ...
        content: [
            {
                ...
                urlImg: images.hygienneIntimePendantLesRegles
            },
            {
                title: "lesDifferentsTypesDeProtegeHygienique",
                category: "Hygiène menstruelle",
                content: ["lesDifferentsTypesDeProtegeHygieniqueContent0"],
                list: ["lesDifferentsTypesDeProtegeHygieniqueContent1", "lesDifferentsTypesDeProtegeHygieniqueContent2", "lesDifferentsTypesDeProtegeHygieniqueContent3", "lesDifferentsTypesDeProtegeHygieniqueContent4", "lesDifferentsTypesDeProtegeHygieniqueContent5"],
                urlImg: images.differentsTypesProtegeHygienique
            }, {
                title: "laServietteHygieniqueJetable",
                category: "Hygiène menstruelle",
                content: ["laServietteHygieniqueJetableContent0", "laServietteHygieniqueJetableContent1"],
                urlImg: images.servitteHygieniqueJetable
            }, {
                title: "laProtectionEnTissu",
                category: "Hygiène menstruelle",
                content: ["laProtectionEnTissuContent0", "laProtectionEnTissuContent1"],
                list: ["laProtectionEnTissuContent2", "laProtectionEnTissuContent3", "laProtectionEnTissuContent4", "laProtectionEnTissuContent5", "laProtectionEnTissuContent6"],
                urlImg: images.protectionEnTissu
            },
            {
                title: "tissuVsServiette",
                category: "Hygiène menstruelle",
                content: ["  "],
                imgInsideArr: [images.imgVs1, images.imgVs2],
                imgInsideArrMg: [images.imgVs1Mg, images.imgVs2Mg],
                urlImg: images.tissuVsServiette
            },
...

            {
                ...
                urlImg: images.servietteHygieniqueLavable
            },
            {
                title: "leProtegeSlip",
                category: "Hygiène menstruelle",
                content: ["leProtegeSlipContent"],
                urlImg: images.protegeSlip
            },
            {
                title: "laCulotteMenstruelle",
                category: "Hygiène menstruelle",
                content: ["laCulotteMenstruelleContent"],
                urlImg: images.culotteMenstruelle
            },
        ...
        content: [
            {
                ...
                urlImg: images.douleurMenstruelle
            }, {
                title: "amenorrhee",
                category: "Troubles et maladies",
                content: ["amenorrheeContent0", "amenorrheeContent1"],
                urlImg: images.abscenceDeRegles
            }, {
                ...
                urlImg: images.saignementDehorsRegles
            }, {
        ...
        content: [
            {
                ...
                list2: ["definitionEtAvantagesContent6", "definitionEtAvantagesContent7", "definitionEtAvantagesContent8", "definitionEtAvantagesContent9"],
                urlImg: images.definitionsEtAvantages
            },

            {
                ...
                urlImg: images.typesDePlanningFamilial
            },

            {
                ...
                list: ["methodeHormonaleContent1", "methodeHormonaleContent2", "methodeHormonaleContent3", "methodeHormonaleContent4", "methodeHormonaleContent5"],
                urlImg: images.methodeHormonale
            }, {
                ...
                urlImg: images.methodeMecanique
            },

            {
                ...
                urlImg: images.methodeNaturelle
            }
            ,
            {
                ...
                urlImg: images.methodeChirurgicale
            },
        ]
    }, {
        content: [
            {
                ...
                list: ["lesBonnesPratiquesDurantLaMenstruationContent1", "lesBonnesPratiquesDurantLaMenstruationContent2", "lesBonnesPratiquesDurantLaMenstruationContent3", "lesBonnesPratiquesDurantLaMenstruationContent4", "lesBonnesPratiquesDurantLaMenstruationContent5"],
                urlImg: images.lesBonnesPratiqueDurantLaMenstruation
            }
            , {
            ...
            , {
                ...
                urlImg: images.soulagerLesDouleursMenstruels  
            }
        ]    
    }
]
